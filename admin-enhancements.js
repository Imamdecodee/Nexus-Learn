...
async function upsertStudentFromCsvRow(row) {
  ...
  const tempPassword = String(row.temporaryPassword || row.initialPassword || row.password || 'ilmnexusds2026!').trim() || 'ilmnexusds2026!';
